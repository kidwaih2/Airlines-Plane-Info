...
class canadian {
    ...
    models;
    startYear;
    constructor(company, numberOfModels, models, startYear) {
...
const flair = new Flair("Flair Airlines", 1, "Boeing 737", 2005);
const porter = new Porter("Porter", 1, "De Havilland Canada Dash 8, Embraer E-195", 2006);
const transat = new airTransat("Air Transat", 2, "Airbus A321, Airbus A330-300", 1987);
const north = new canadianNorth("Canadian North", 3, "Boeing 737, ATR-42, ATR-72", 1989);
const sunwing = new Sunwing("Sunwing Airlines", 1, "Boeing 737", 2005);
// American Airlines
const united = new United("United Airlines", 10, "Airbus A319, Airbus A320, Airbus A321, Boeing 737, Boeing 757, Boeing 767, Boeing 777, Boeing 787 Dreamliner, Embraer E-170, Embraer E-175", 1926);
const aa = new americanAirlines("American Airlines", 10, "Airbus A319, Airbus A320, Airbus A321, Boeing 737, Boeing 757, Boeing 767, Boeing 777, Boeing 787 Dreamliner, Embraer E-170, Embraer E-175", 1930);
const delta = new Delta("Delta Air Lines", 10, "Airbus A220, Airbus A319, Airbus A320, Airbus A321, Boeing 717, Boeing 737, Boeing 757, Boeing 767, Boeing 767, Boeing 787 Dreamliner", 1928);
const alaska = new Alaska("Alaska Airlines", 1, "Boeing 737", 1932);
const hawaii = new Hawaiian("Hawaiian Airlines", 4, "Airbus A321, Airbus A330, Boeing 717, Boeing 767, Boeing 787 Dreamliner", 1929);
const allegiant = new Allegiant("Allegiant Air", 4, "Airbus A319, Airbus A320, Boeing 737", 1997);
const jetblue = new jetBlue("JetBlue Airways", 3, "Airbus A320, Airbus A321, Embraer E-190", 1998);
const southwest = new Southwest("Southwest Airlines", 1, "Boeing 737", 1966);
const spirit = new Spirit("Spirit Airlines", 3, "Airbus A319, Airbus A320, Airbus A321", 1992);
const frontier = new Frontier("Frontier Airlines", 3, "Airbus A319, Airbus A320, Airbus A321", 1994);
const allAirlines = [
    // Canadian
